const app1 = Vue.createApp({
    ...
    computed: {
        sonuc() {
            if (this.sayac < 37) {
                return 'daha yolun var';
            }
            else if (this.sayac === 37) {
                return this.sayac;
            }
            else {
                return 'çok gittin';
    ...
    methods: {
        SonucArttir(artimMiktari) {
            this.sayac = this.sayac + artimMiktari;
        }
    },
    watch: {
        sonuc() {
...
const app2 = Vue.createApp({
    ...
    computed: {
        Isim() {
            return this.ben.ad + " " + this.ben.soyad;
        },
        // Yas() {
        //     return this.ben.yas;
        // },
        Yas10() {
            return this.ben.yas + 10;
        },
        FavoriSayi() {
            return Math.random();
        }
...
app1.mount('#assignment_1');
app2.mount('#assignment_2');